...
This repo contains a bash script which performs tests against your system to give an indication of whether the running server may compliy with the CIS Benchmarks. https://learn.cisecurity.org/benchmarks

_Only CentOS 7 and MySQL Community Server 5.7 is supported at this time._

### How do I use this?

#### Download:

Download the scripts you are interested in and run `chmod 750 cis-audit-<type>.sh`.

#### Run:

```
# ./cis-audit-<type>.sh --help
...
No changes are made to system files by this script.
  ...
  Options:
    -h,  --help                  Prints this help text
         ...
         --user                  Specifies the user for MySQL (only for the MySQL script)
